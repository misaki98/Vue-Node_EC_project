<template>
  <header class="header">
    ...
    <div class="navbar">
      ...
      <div class="navbar-right-container" style="display: flex;">
        <div class="navbar-menu-container">
          ...
          <span class="navbar-link" v-if="nickName">{{ $store.state.nickName }}</span>
          <a href="#" @click.prevent="loginModalFlag=true" v-if="!nickName" class="navbar-link">Login</a>
          <a href="#" @click.prevent="logout" v-if="nickName" class="navbar-link">Logout</a>
          <div class="navbar-cart-container">
            <span class="navbar-cart-count">{{ $store.state.cartCount }}</span>
    ...
    <model :loginModalFlag="loginModalFlag" @close="closeModal">
      <div slot="content">
      ...
      <a href="javascript:;" class="btn-login" @click="login" slot="btn-group">登 录</a>
    </model>
  </header>
</template>
