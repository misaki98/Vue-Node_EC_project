<template>
  <div>
        ...
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in addressListFilter"
                    ...
                    @click="selectId(index,item.addressId)">
                  <dl>
                    <dt>{{ item.userName }}</dt>
                  ...
                  <div class="addr-opration addr-set-default">
                    <a class="addr-set-default-btn"
                       v-if="!item.isDefault"
                       @click.prevent="setDafault(item.addressId)"><i>Set default</i></a>
                  </div>
            ...
            <div class="shipping-addr-more">
              <a class="addr-more-btn up-down-btn" @click.prevent="expand" :class="{'open':limit>3}">
                more
                <i class="i-up-down">
    ...
    <Model :loginModalFlag="modalFlag1" @close="closeModal">
      ...
      <div slot="btn-group">
        <button class="btn btn--m" @click="delAddress">确认</button>
